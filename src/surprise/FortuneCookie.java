...
public class FortuneCookie implements ISurprise {
    ...
    // Static method used for generating a random FortuneCookie
    public static FortuneCookie generate() {
        int index = FortuneCookie.random.nextInt(FortuneCookie.quotes.length);
        String message = FortuneCookie.quotes[index];
    ...
    // Enjoy method - it will print out the FortuneCookie's message
    @Override
    public void enjoy() {
